...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2026 a las 17:52:39
...
--
CREATE DATABASE IF NOT EXISTS `mi_base` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mi_base`;
...
(3, 'la mas turra', 'la princesa del rap', 323, '44.00', 'paris 234', '2026-01-20', '18:31:00', '75ed73fa7fb1cbef81453cc58306f2e5.jpg'),
(4, 'nicky nicole', 'la mejor del mundo', 1111, '2222.00', 'belgrano 444', '2026-01-28', '13:33:00', '7d5c57b4884e1b82e990fa0e8c5e37b6.jpg'),
(5, 'duki el trapero del norte', 'el trapero del sur', 1, '12.00', 'paris 234', '2026-01-31', '17:33:00', '9387321787fe94258ecac36747c3e398.jpg'),
(6, 'maria becerra', 'la mas dulce de quilmes', 222, '12.00', 'camino negro 3333', '2026-02-07', '13:35:00', '430f265b1b0ceb9d0ef28892eb3e455b.jpg'),
(9, 'el relampago', 'restaurador de economia', 3333, '22.00', 'lanus 22111', '2026-01-31', '14:51:00', '2ce66999796c36e3b84cd6cfcc67767e.jpg');
...
(4, 3, 3, 3, '2026-01-27', '132.00'),
(5, 3, 3, 3, '2026-01-27', '132.00'),
(6, 3, 3, 2, '2026-01-27', '88.00'),
(7, 3, 3, 2, '2026-01-27', '88.00');
...
(1, 1, 'ivaninfonorte@gmail.com', '1234', 'gerardo', 'fernandez', 34234433, '11-4156-3813'),
(2, 1, 'ivaninfosur@gmail.com', '1234', 'miguel', 'angel', 2147483647, '11-2310-8788'),
(3, 1, 'ivaninfoeste@gmail.com', '1234', 'estiven', 'flores', 12345678, '4444-4444'),
(5, 2, 'ivaninfonet@gmail.com', '1234', 'pablo', 'tolaba', 2211112, '5555-6666'),
(6, 2, 'ivaninfonet2@gmail.com', '1234', 'fabian', 'gauto', 44444, '6666-5555'),
(8, 1, 'ivaninfoeste2@gmail.com', '$2y$10$B9ssbRZhUx81dGPF293ioO4MJTqz702kpY0rfHW.2Umyh3NKxzpVi', 'ivan', 'pablo', 0, '');
...
--
ALTER TABLE `espectaculos`
  MODIFY `id_espectaculo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
('root', '2025-12-26 03:40:24', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
